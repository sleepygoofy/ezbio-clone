...
import './App.css';
import pfp from '../images/edger.gif';
import view from '../images/viewW.svg';
import twitter from '../images/x.png';
import insta from '../images/insta.png';
import yt from '../images/yt.png';
import discord from '../images/discord.png';
import cover from '../images/cover4.jpeg';
import stop from '../song/lil.mp3';
import bg from '../videos/b3.mp4';
    ...
    <div className='app-container'>
      ...
      <div className={`main-container ${entered ? 'entered' : ''}`}>
        ...
        <div className='song'>
          ...
          <a href='https://open.spotify.com/track/5E9qBEUja2yAjUPhQO8Gx7' target='_blank' rel='noopener noreferrer'>
            <img src={cover} className='songcover' alt='' />
          </a>
          <div className='songinfo'>
            <p1 className='songtitle'>life imitates life</p1>
            <p1 className='artist'>by quannnic</p1>
            <p1 className='album' href>on kenopsia</p1>
          </div>
